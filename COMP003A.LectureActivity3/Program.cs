...
namespace COMP003A.LectureActivity3
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            if (inputNumber % 2 == 0)
            {
                // this code block executs if the above condition is true
            ...
            if (inputNumber % 2 == 0)
            {
                // this code block will execute if inputNumber is divisible by 2
                Console.WriteLine("\tinputNumber is even");
            }
            else
            {
                // this code block will execute if the above condition is false
            ...
            if (inputNumber % 2 == 0)
            {
                // this code block will execute in inputNumber is divisible by 2
                Console.WriteLine("\tinputNumber is even");
                ...
                else
                {
                    ...
                    Console.WriteLine("\t\tinputNumber is NOT divisble by 5");
                }
            }
            else
            {
            ...
            {
                // this code block will execute if the above conditions are NOT true
            ...
            int randomNumber = new Random().Next(10); // generates a random # 10 or below
            ...
            Console.WriteLine("8. switch statements");
            // switch statement
            switch (inputNumber)
            {
                case 2:
                ...
                case 7:
                    ...
                    break; // exits out of the switch
                default:
                    // this code block executes if none of the cases are true
